...
#===============================================Buttons For Clear Cart============================================================
        self.btn_clear_cart = Button(Add_CartWidgetsFrame,
                             text="Clear",
                             command=self.clear_cart,
                             font=("times new roman",15,"bold"),
                             bg="lightgray",
                             cursor="hand2")
        self.btn_clear_cart.place(x=180, y=70, width=150, height=30)

        self.root.bind("<BackSpace>", lambda event: self.btn_clear_cart.invoke())

#===============================================Buttons For Add | update  Cart============================================================
        self.btn_add_cart = Button(Add_CartWidgetsFrame,
                           text="Add | Update Cart",
                           command=self.add_update_cart,
                           font=("times new roman",15,"bold"),
                           bg="orange",
                           cursor="hand2")
        self.btn_add_cart.place(x=340,y=70,width=180,height=30)

        self.root.bind("<space>", lambda event: self.btn_add_cart.invoke())
...
#=============================================BUTTON FOR PRINT RECEIPT ======================================================================================================================================
        self.btn_print=Button(billMenuFrame,text="Print",command=self.print_bill,font=("goudy old style",15,"bold"),bg="blue",fg="white",cursor="hand2")
        self.btn_print.place(x=2,y=80,width=120,height=50)
        self.root.bind("<p>", lambda event: self.btn_print.invoke())
        
#=============================================BUTTON FOR CLEAR GENERATED ALL=======================================================================================================================================
        self.btn_clear_all=Button(billMenuFrame,text="Clear All",command=self.clear_all,font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2")
        self.btn_clear_all.place(x=124,y=80,width=120,height=50)
        self.root.bind("<Escape>", lambda event: self.btn_clear_all.invoke())
        
#=============================================BUTTON FOR GENERATE BILL=======================================================================================================================================
        self.btn_generate=Button(billMenuFrame,text="Generate/Save Bill",command=self.generate_bill,font=("goudy old style",15,"bold"),bg="#009688",fg="white",cursor="hand2")
