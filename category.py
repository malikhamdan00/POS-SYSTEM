...
# =========================================Adding "ADD" button=====================================================================================================
        self.txt_add = Button(self.root, text="ADD", command=self.add,
                      font=("goudy old style", 15), bg="#4caf50", fg="white", cursor="hand2")
        self.txt_add.place(x=360, y=170, width=150, height=30)

        self.root.bind("<Return>", lambda event: self.txt_add.invoke())
# =========================================Adding  "DELETE" button======================================================================================================

        self.txt_delete = Button(self.root, text="Delete", command=self.delete,
                         font=("goudy old style", 15), bg="red", fg="white", cursor="hand2")
        self.txt_delete.place(x=520, y=170, width=150, height=30)

        self.root.bind("<space>", lambda event: self.txt_delete.invoke())
