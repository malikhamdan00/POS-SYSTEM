...
# ======================================================Buttons============================================
        self.btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2")
        self.btn_add.place(x=10,y=400,width=100,height=40)
        self.root.bind("<Return>", lambda event: self.btn_add.invoke())
        self.btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2")
        self.btn_update.place(x=120,y=400,width=100,height=40)
        self.root.bind("<space>", lambda event: self.btn_update.invoke())
        self.btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white",cursor="hand2")
        self.btn_delete.place(x=230,y=400,width=100,height=40)
        self.root.bind("<Delete>", lambda event: self.btn_delete.invoke())
        self.btn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2")
        self.btn_clear.place(x=340,y=400,width=100,height=40)
