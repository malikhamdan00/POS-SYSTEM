...
#=======================================================Search button==and clear button=======================================================================================
        self.btn_search=Button(self.root,text="Search",command=self.search,font=("times new roman",15,"bold"),bg="#2196f3",fg="white",cursor="hand2")
        self.btn_search.place(x=360,y=100,width=120,height=28)
        self.root.bind("<Return>", lambda event: self.btn_search.invoke())
        self.btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="lightgray",fg="black",cursor="hand2")
        self.btn_clear.place(x=490,y=100,width=120,height=28)
